    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('gudang.tambahsupplier') }}">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="NoTelpon" type="text" class="form-control @error('NoTelpon') is-invalid @enderror" name="noTelp" required>
