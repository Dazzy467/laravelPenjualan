@section('sidebar')
    ...
    <nav id="sidebar" class="sidebar position-fixed z-1 container bg-primary overflow-y-auto">
        ...
        <div class=" pt-2" id="sidebarCollapse">
            ...
            <div>
                <div class="text-center text-white nav-label"><h1>Manajemen Gudang</h1></div>
            </div>
            <!-- Nav link -->
            <ul id="navlink" class="container mt-5">
                <li class="row">
                    <a href="{{route('gudang.show')}}" class="btn btn-primary d-flex align-items-center" style="text-decoration: none;">
                ...
                <li class="row">
                    <a href="{{ route('gudang.kelolabarang') }}" class="btn btn-primary d-flex align-items-center mt-3" style="text-decoration: none;">
                        <span class="text-white col nav-label" style="text-align: start;font-weight: bolder; font-size:14px;">Kelola Barang</span>
                        <i class="fa-solid fa-box text-white col-2 nav-icon" style="font-size: 32px; padding-left: 2px;"></i>
                    </a>
                </li>
                <li class="row">
                    <a href="{{ route('gudang.kelolasupplier') }}" class="btn btn-primary d-flex align-items-center mt-3" style="text-decoration: none;">
                        <span class="text-white col nav-label" style="text-align: start; font-weight: bolder; font-size:14px;">Kelola Supplier</span>
                        <i class="fa-solid fa-truck-field text-white col-2 nav-icon" style="font-size: 32px; padding-left: 4px;"></i>
                    </a>
                </li>
                <li class="row">
